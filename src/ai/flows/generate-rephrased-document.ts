...
- 'learning': A very expanded and detailed ${tone} elaboration of what the student learned (15-20 lines). Provide in-depth analysis, explanations, and examples. CRITICAL: This section MUST be formatted with a mix of paragraphs and bullet points. Include 4-6 bullet points interspersed throughout. IMPORTANT: Each bullet point MUST start on a NEW LINE beginning with an asterisk followed by a space (format: "* Point text here"). Do NOT put asterisks in the middle of sentences or paragraphs. Example format:\nParagraph text here.\n* First bullet point\n* Second bullet point\nMore paragraph text.\n* Another bullet point\nThis makes the content more scannable and less like one long paragraph.
